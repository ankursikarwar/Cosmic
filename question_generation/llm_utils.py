...
def get_api_base_from_github(repo_url: str = "https://github.com/ankursikarwar/mila-api-base") -> Optional[str]:
    """
...
def create_client_from_github(
    repo_url: str = "https://github.com/ankursikarwar/mila-api-base",
    api_key: str = "NONE",
    model_name: str = "default"
