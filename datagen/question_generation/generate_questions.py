...
def main():
    ...
    questions_output = {
        "global_counting_questions": generate_counting_questions(data, ground_data, args.num_options),
        "anchor_recognition_questions": generate_anchor_questions(
        ...
        "relative_direction_questions": generate_spatial_orientation_questions(
