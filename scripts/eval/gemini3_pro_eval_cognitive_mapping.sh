#!/bin/bash
#SBATCH --job-name=gemini3_pro_eval_map
#SBATCH --partition=long-cpu
#SBATCH -c 8
#SBATCH --output=/path/to/slurm/logs/output/gemini3_pro_eval_map-%j.txt
#SBATCH --error=/path/to/slurm/logs/error/gemini3_pro_eval_map-%j.txt
#SBATCH --ntasks=1
