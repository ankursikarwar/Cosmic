#!/bin/bash
#SBATCH --job-name=gemma_27B_eval_spatial
#SBATCH --partition=long-cpu
#SBATCH -c 8
#SBATCH --output=/path/to/slurm/logs/output/gemma_27B_eval_spatial-%j.txt
#SBATCH --error=/path/to/slurm/logs/error/gemma_27B_eval_spatial-%j.txt
#SBATCH --ntasks=1
