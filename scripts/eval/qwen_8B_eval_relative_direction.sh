#!/bin/bash
#SBATCH --job-name=qwen_8B_eval_spatial
#SBATCH --partition=long-cpu
#SBATCH -c 8
#SBATCH --output=/path/to/slurm/logs/output/qwen_8B_eval_spatial-%j.txt
#SBATCH --error=/path/to/slurm/logs/error/qwen_8B_eval_spatial-%j.txt
#SBATCH --ntasks=1
