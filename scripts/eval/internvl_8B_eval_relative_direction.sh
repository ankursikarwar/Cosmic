#!/bin/bash
#SBATCH --job-name=internvl_8B_eval_spatial
#SBATCH --partition=long-cpu
#SBATCH -c 8
#SBATCH --output=/path/to/slurm/logs/output/internvl_8B_eval_spatial-%j.txt
#SBATCH --error=/path/to/slurm/logs/error/internvl_8B_eval_spatial-%j.txt
#SBATCH --ntasks=1
