#!/bin/bash
#SBATCH --job-name=internvl_8B_eval_relative
#SBATCH --partition=long-cpu
#SBATCH -c 8
#SBATCH --output=/path/to/slurm/logs/output/internvl_8B_eval_relative-%j.txt
#SBATCH --error=/path/to/slurm/logs/error/internvl_8B_eval_relative-%j.txt
#SBATCH --ntasks=1
