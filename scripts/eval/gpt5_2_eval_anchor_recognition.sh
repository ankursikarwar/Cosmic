#!/bin/bash
#SBATCH --job-name=gpt5_2_eval_anchor
#SBATCH --partition=long-cpu
#SBATCH -c 8
#SBATCH --output=/path/to/slurm/logs/output/gpt5_2_eval_anchor-%j.txt
#SBATCH --error=/path/to/slurm/logs/error/gpt5_2_eval_anchor-%j.txt
#SBATCH --ntasks=1
