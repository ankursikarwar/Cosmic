#!/bin/bash
#SBATCH --job-name=qwen_32B_eval_relative_sa
#SBATCH --partition=long-cpu
#SBATCH -c 8
#SBATCH --output=/path/to/slurm/logs/output/qwen_32B_eval_relative_sa-%j.txt
#SBATCH --error=/path/to/slurm/logs/error/qwen_32B_eval_relative_sa-%j.txt
#SBATCH --ntasks=1
