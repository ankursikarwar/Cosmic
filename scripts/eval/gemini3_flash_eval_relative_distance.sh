#!/bin/bash
#SBATCH --job-name=gemini3_flash_eval_relative
#SBATCH --partition=long-cpu
#SBATCH -c 8
#SBATCH --output=/path/to/slurm/logs/output/gemini3_flash_eval_relative-%j.txt
#SBATCH --error=/path/to/slurm/logs/error/gemini3_flash_eval_relative-%j.txt
#SBATCH --ntasks=1
