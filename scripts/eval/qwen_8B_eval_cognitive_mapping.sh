#!/bin/bash
#SBATCH --job-name=qwen_8B_eval_map
#SBATCH --partition=long-cpu
#SBATCH -c 8
#SBATCH --output=/path/to/slurm/logs/output/qwen_8B_eval_map-%j.txt
#SBATCH --error=/path/to/slurm/logs/error/qwen_8B_eval_map-%j.txt
#SBATCH --ntasks=1
